...
namespace ProjetoFinal
{
	public class Perfil
	{
		...
		public IndiceAtividadeFisica AtvFisica { get; set; }
		...
		public int GerarDieta(string nome, Objetivo Obj) {
			...
			var dieta = new Dieta(nome, totalKcal, gramasProt, gramasCarb, gramasGord);
